...
using Demo_Project__ASP.NET_Core_Web_API_.Models;

namespace Demo_Project__ASP.NET_Core_Web_API_.Controllers
{
    ...
    public class UserDetailsController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDetail>> PostUserDetail(UserDetail userDetail)
        {
          if (_context.UserDetails == null)
          {
              return Problem("Entity set 'UserContext.UserDetails'  is null.");
          }
